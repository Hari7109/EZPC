...
<html lang="en">
    ...
    <body>
        ...
        <section id="main">
            ...
            <h1 class="" style="color: white;">On all products</h1>
           
            <button class="btn " style="color: white;">Shop Now</button>
        </section> 

        <section id="feature" class="section-p1">
            <div class="fe-box">
                <img src="img/features/f1.png" alt="">
                <h6>Free Comparing</h6>
            </div>
            <div class="fe-box">
        ...
        <section id="banner" class="section-m1">
            ...
            <h2>Upto <span>70% Off</span> -  Accessories</h2>
            <button class="normal">Explore More</button>
        </section>

        <section id="product1" class="section-p1">
            <h2>New Arrivals</h2>
            <p>ROG Matrix GeForce RTX 4090 Graphics Card</p>
        ...
        <section id="sm-banner" class="section-p1">
            ...
            <div class="banner-box banner-box2">
                ...
                <h2>NVIDIA RTX 5000 Ada</h2>
                <span>Performance for endless possibilities</span>
        ...
        <section id="banner3">
            <div class="banner-box">
                <h2 class="" >SEASONAL SALE</h2>
                
            </div>
            <div class="banner-box banner-box2">
                <h2>NEW PART COLLECTION</h2>
